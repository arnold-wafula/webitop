...
class __TwigTemplate_b038b4b0dc8eb3c92db829f6fed0db2a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_iboPopoverMenuItem($context, array $blocks = [])
    {
        ...
        echo "\" onclick=\"";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["oUIBlock"] ?? null), "GetJsCode", [], "method", false, false, false, 4));
        echo "\"
            ";
        // line 5
...
";
    ...
    {
        return new Source("", "base/components/popover-menu/item/mode_js.html.twig", "C:\\xampp\\htdocs\\web\\templates\\base\\components\\popover-menu\\item\\mode_js.html.twig");
    }
}
