...
class __TwigTemplate_7a22f33bda3d950d96cc534b43f818bb extends Template
{
    private $source;
    private $macros = [];
...
($context["oTab"] ?? null), "GetType", [], "method", false, false, false, 22) == twig_constant("TabManager::ENUM_TAB_TYPE_HTML"))) {
    ...
    {
        return new Source("", "base/layouts/tab-container/layout.html.twig", "C:\\xampp\\htdocs\\web\\templates\\base\\layouts\\tab-container\\layout.html.twig");
    }
}
