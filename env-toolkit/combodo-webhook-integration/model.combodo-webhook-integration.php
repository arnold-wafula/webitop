<?php
//
// File generated by ... on the 2024-02-16T09:49:05+0100
// Please do not edit manually
//

/**
 * Classes and menus for combodo-webhook-integration (version 1.3.2)
 *
...
class RemoteiTopConnectionToken extends RemoteApplicationConnection
{
	public static function Init()
	{
		...
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("version", array("sql"=>'version', "is_null_allowed"=>false, "default_value"=>'1.3', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEncryptedString("token", array("sql"=>'token', "is_null_allowed"=>false, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class ActionWebhook extends Combodo\iTop\Core\Notification\Action\_ActionWebhook
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeApplicationLanguage("language", array("sql"=>'language', "is_null_allowed"=>false, "default_value"=>'EN US', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class MenuCreation_combodo_webhook_integration extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['Integrations'] = new DashboardMenuNode('Integrations', __DIR__.'/integrations_dashboard.xml', $__comp_menus__['ConfigurationTools']->GetIndex(), 120 , 'RemoteApplicationConnection', UR_ACTION_MODIFY, UR_ALLOWED_YES, null);
	}
