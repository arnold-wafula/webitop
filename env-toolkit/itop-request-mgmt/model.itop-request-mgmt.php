<?php
//
// File generated by ... on the 2024-02-09T14:10:27+0100
// Please do not edit manually
//

/**
 * Classes and menus for itop-request-mgmt (version 3.1.1)
 *
...
class UserRequest extends Ticket
{
	public static function Init()
	{
		$aParams = array(			'category' => 'bizmodel,searchable,requestmgmt',
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'style' =>  new ormStyle('ibo-dm-class--UserRequest', 'ibo-dm-class-alt--UserRequest', 'var(--ibo-dm-class--UserRequest--main-color)', null, null, 'itop-request-mgmt/images/user-request.svg'),
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("priority", array("allowed_values"=>new ValueSetEnum("1,2,3,4" ), "styled_values"=>['1' =>  new ormStyle('ibo-dm-enum--UserRequest-priority-1', 'ibo-dm-enum-alt--UserRequest-priority-1', 'var(--ibo-dm-enum--UserRequest-priority-1--main-color)', 'var(--ibo-dm-enum--UserRequest-priority-1--complementary-color)', 'fas fa-fire', null),'2' =>  new ormStyle('ibo-dm-enum--UserRequest-priority-2', 'ibo-dm-enum-alt--UserRequest-priority-2', 'var(--ibo-dm-enum--UserRequest-priority-2--main-color)', 'var(--ibo-dm-enum--UserRequest-priority-2--complementary-color)', null, null),'3' =>  new ormStyle('ibo-dm-enum--UserRequest-priority-3', 'ibo-dm-enum-alt--UserRequest-priority-3', 'var(--ibo-dm-enum--UserRequest-priority-3--main-color)', 'var(--ibo-dm-enum--UserRequest-priority-3--complementary-color)', null, null),'4' =>  new ormStyle('ibo-dm-enum--UserRequest-priority-4', 'ibo-dm-enum-alt--UserRequest-priority-4', 'var(--ibo-dm-enum--UserRequest-priority-4--main-color)', 'var(--ibo-dm-enum--UserRequest-priority-4--complementary-color)', null, null)], "default_style"=> new ormStyle('ibo-dm-enum--UserRequest-priority', 'ibo-dm-enum-alt--UserRequest-priority', 'var(--ibo-dm-enum--UserRequest-priority--main-color)', 'var(--ibo-dm-enum--UserRequest-priority--complementary-color)', null, null), "display_style"=>'list', "sql"=>'priority', "default_value"=>'4', "is_null_allowed"=>false, "depends_on"=>array('impact', 'urgency'), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("approver_id", array("targetclass"=>'Person', "allowed_values"=>new ValueSetObjects("SELECT Person WHERE org_id= :this->org_id"), "sql"=>'approver_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "allow_target_creation"=>false, "display_style"=>'select', "create_temporary_object"=>false, "depends_on"=>array('org_id'), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_DefineHighlightScale( array(
		    'warning' => array('rank' => 1, 'color' => HILIGHT_CLASS_WARNING, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-request-mgmt/images/user-request-deadline.svg'),
		    'critical' => array('rank' => 2, 'color' => HILIGHT_CLASS_CRITICAL, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-request-mgmt/images/user-request-escalated.svg'),
		    'closed' => array('rank' => 3, 'color' => HILIGHT_CLASS_NONE, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-request-mgmt/images/user-request-closed.svg'),
		));
